    ...
    <div className="container ">
      ...
      <div className="row">
        ...
        <div className="col-4">
          ...
          <Card title="What is Computer" subTitle="Some quick example text to build on the card title and make up
                  the bulk of the card's content." button="Read More" />
        </div>
        <div className="col-4">
          {/* <div className="card" style={{ width: "18rem" }}>
            <img
          ...
          <Card title="What is Internet" subTitle="Some quick example text to build on the card title and make up
                  the bulk of the card's content." button="Know More" />
        </div>
      </div>
    </div>
  </section>
